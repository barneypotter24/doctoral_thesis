...
as a [GitHub issue](https://github.com/wannesm/kulphd/issues) or a [GitHub pull request](https://help.github.com/articles/using-pull-requests).
...
[github.com/wannesm/kulphd](https://github.com/wannesm/kulphd).

Questions and issues can be submitted to the 
[ADS PhD issues component](https://github.com/wannesm/kulphd/issues) 
at Github.
...
The kulphd.cls class can be used directly by latex:
...
The following packages are loaded automatically by the kulphd.cls class:
