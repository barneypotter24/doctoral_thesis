...
#
# Very naive compilation script for the kulphd class.
#
...
def cover():
    ...
    with open('cover.tex','w') as cf:
        cf.write("""% Cover.tex
\\documentclass[cam,cover{}]{{kulphd}}""".format(extra_usersettings))
        cf.write("""
\\usepackage{printlen}
\\uselengthunit{mm}
""")
...
\\setlength{\\fullpagewidth}{2\\kulphdpaperwidth}
\\addtolength{\\fullpagewidth}{2\\defaultlbleed}
\\addtolength{\\fullpagewidth}{2\\defaultrbleed}
\\addtolength{\\fullpagewidth}{\\kulphdspinewidth}

\\geometry{
	paperwidth=\\fullpagewidth,
	paperheight=\\kulphdpaperheight,
}
...
\\makefullcoverpage{\\kulphdspinewidth}{}
...
\\begin{itemize}
	\\item Spine width: \\printlength{\\kulphdspinewidth}
	\\item Left bleed: \\printlength{\\lbleed}
	\\item Right bleed: \\printlength{\\rbleed}
	\\item Paper width: \\printlength{\\kulphdpaperwidth}
	\\item Paper height: \\printlength{\\kulphdpaperheight}
...
def main(argv=None):
	...
	parser = argparse.ArgumentParser(
		    description='''
Naive compilation script for the kulphd class. No file dependency checks
