...
$(COVERTEX): $(MAINTEX) $(MYCOVERPAGE) kulphd.cls Makefile
	...
	@echo "\setlength{\fullpagewidth}{2\kulphdpaperwidth}"         >> $@
	@echo "\addtolength{\fullpagewidth}{2\defaultlbleed}"           >> $@
	@echo "\addtolength{\fullpagewidth}{2\defaultrbleed}"           >> $@
	@echo "\addtolength{\fullpagewidth}{\kulphdspinewidth}"        >> $@
	@echo ""                                                       >> $@
	@echo "\geometry{"                                             >> $@
	@echo "	paperwidth=\fullpagewidth,"                            >> $@
	@echo "	paperheight=\kulphdpaperheight,"                       >> $@
	@echo "}"                                                      >> $@
	@echo ""                                                       >> $@
	...
	@echo "\begin{document}" 									                     >> $@
	@echo ""                                                       >> $@
	@echo "\makefullcoverpage{\kulphdspinewidth}{}"  							 >> $@
	@echo ""                                                       >> $@
	@echo "\newlength{\testje}"                                    >> $@
	...
	@echo "\begin{itemize}"                                        >> $@
	@echo "	\item Spine width: \printlength{\kulphdspinewidth}"    >> $@
	@echo "	\item Left bleed: \printlength{\lbleed}"               >> $@
	@echo "	\item Right bleed: \printlength{\rbleed}"              >> $@
	@echo "	\item Paper width: \printlength{\kulphdpaperwidth}"    >> $@
	@echo "	\item Paper height: \printlength{\kulphdpaperheight}"  >> $@
