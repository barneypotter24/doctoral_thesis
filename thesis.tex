...
\newglossaryentry{pcr}{name={PCR},description={Polymerase chain reaction. A method used for the amplication of genetic material so that it may be used for both diagnostics (i.e PCR testing for COVID-19), or for whole genome sequencing}}
