...
\externaljurymember{external1}{role}
\externaljurymember{external2}{role2}
...
\newglossaryentry{hiv}{name={HIV},description={Human immunodeficiency virus. PUT IN MORE DETAILS}}
...
\newglossaryentry{lasv}{name={placeholder},description={placeholder}}
\newglossaryentry{dag}{name={placeholder},description={placeholder}}
\newglossaryentry{hmc}{name={placeholder},description={placeholder}}
